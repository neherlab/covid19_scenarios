...
export class Convert {
  ...
  public static ageDistributionArrayToJson(value: AgeDistributionArray): string {
  ...
  public static ageDistributionDatumToJson(value: AgeDistributionDatum): string {
  ...
  public static toScenarioDatumEpidemiological(json: string): ScenarioDatumEpidemiological {
    return cast(JSON.parse(json), r('ScenarioDatumEpidemiological'))
  }

  public static scenarioDatumEpidemiologicalToJson(value: ScenarioDatumEpidemiological): string {
    return JSON.stringify(uncast(value, r('ScenarioDatumEpidemiological')), null, 2)
  }

  public static toNumericRangeNonNegative(json: string): NumericRangeNonNegative {
    return cast(JSON.parse(json), r('NumericRangeNonNegative'))
  }

  public static numericRangeNonNegativeToJson(value: NumericRangeNonNegative): string {
    return JSON.stringify(uncast(value, r('NumericRangeNonNegative')), null, 2)
  }

  public static toScenarioDatumMitigation(json: string): ScenarioDatumMitigation {
    return cast(JSON.parse(json), r('ScenarioDatumMitigation'))
  }

  public static scenarioDatumMitigationToJson(value: ScenarioDatumMitigation): string {
  ...
  public static toScenarioDatumPopulation(json: string): ScenarioDatumPopulation {
    return cast(JSON.parse(json), r('ScenarioDatumPopulation'))
  }

  public static scenarioDatumPopulationToJson(value: ScenarioDatumPopulation): string {
    return JSON.stringify(uncast(value, r('ScenarioDatumPopulation')), null, 2)
  }

  public static toScenarioDatumSimulation(json: string): ScenarioDatumSimulation {
    return cast(JSON.parse(json), r('ScenarioDatumSimulation'))
  }

  public static scenarioDatumSimulationToJson(value: ScenarioDatumSimulation): string {
    return JSON.stringify(uncast(value, r('ScenarioDatumSimulation')), null, 2)
  }

  public static toSeverityDistributionArray(json: string): SeverityDistributionArray {
    return cast(JSON.parse(json), r('SeverityDistributionArray'))
  }

  public static severityDistributionArrayToJson(value: SeverityDistributionArray): string {
    return JSON.stringify(uncast(value, r('SeverityDistributionArray')), null, 2)
  }

  public static toSeverityDistributionData(json: string): SeverityDistributionData {
    return cast(JSON.parse(json), r('SeverityDistributionData'))
  }

  public static severityDistributionDataToJson(value: SeverityDistributionData): string {
    return JSON.stringify(uncast(value, r('SeverityDistributionData')), null, 2)
  }

  public static toSeverityDistributionDatum(json: string): SeverityDistributionDatum {
    return cast(JSON.parse(json), r('SeverityDistributionDatum'))
  }

  public static severityDistributionDatumToJson(value: SeverityDistributionDatum): string {
...
const typeMap: any = {
  AgeDistributionArray: o([{ json: 'all', js: 'all', typ: a(r('AgeDistributionData')) }], false),
  ...
  CaseCountsArray: o([{ json: 'all', js: 'all', typ: a(r('CaseCountsData')) }], false),
  CaseCountsData: o(
    [
  ...
  ScenarioArray: o([{ json: 'all', js: 'all', typ: a(r('ScenarioData')) }], false),
  ScenarioData: o(
    [
  ...
  SeverityDistributionArray: o([{ json: 'all', js: 'all', typ: a(r('SeverityDistributionData')) }], false),
