...
<figure className="figure w-100 text-center">
  ...
  <figcaption className="figure-caption text-center">
    ...
    but in ICU overflow (O), those in palliative care (P), and fatalities (D).
  </figcaption>
</figure>
...
critical before dying or stabilizing is $t_c$. While the fraction of infectious that are asymptomatic or mild is $m_a$,
the fraction of severe cases that turn critical is $c_a$, and the fraction of critical cases that are fatal is $f_a$.
