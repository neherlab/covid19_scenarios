...
transmission. The curve is read out and used to change transmission relative to the base line parameters for R0 and seasonality.
...
Other studies investigate the effect of [school closures on influenza transmission](https://www.pnas.org/content/116/27/13174).
