  ...
  return (
    ...
    >
      <FormSpinBox
        ...
        label={t('Population')}
        help={help(t('Population'), t('Number of people served by health care system.'))}
        step={1}
        errors={errors}
        touched={touched}
      />
      ...
      <FormSpinBox
        ...
        help={help(t('Initial suspected cases'), t('Number of cases present at the start of simulation'))}
        step={1}
        errors={errors}
        touched={touched}
      />
      <FormSpinBox
        ...
        help={help(t('Imports per day'), t('Number of cases imported from the outside per day on average'))}
        step={0.1}
        errors={errors}
        touched={touched}
      />
