...
The second column shows how many people fall into each age group.
...
Most fields are editable and can be adjusted to different assumptions.
The last column can be used to specify age-group-specific isolation measures.
