...
function SeverityCard({ severity, setSeverity }: SeverityCardProps) {
  return (
    ...
    >
      <p>
        This table summarizes the assumptions on severity which are informed by
        epidemiological and clinical observations in China. The first column
        reflects our assumption on what fraction of infections are reflected in
        the statistics from China, the following columns contain the assumption
        ...
        The last column is the implied infection fatality for different age
        groups.
      </p>
