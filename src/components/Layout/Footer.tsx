...
​
          <a href="https://github.com/neherlab/covid19_scenarios/releases" id="builder">
            <small data-tip data-for="buildtip" className="text-gray-light">{buildNumber}</small>
          </a>
          <ReactTooltip id="buildtip" place="top" effect="solid">
            Most Recent Release
          </ReactTooltip>
        </Col>
      </Row>
