...
- [Hauser et al](https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1003189) compiled data from
  multiple different countries and estimated age-specific IFRs.
