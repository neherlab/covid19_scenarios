...
The source code of this tool is freely available at [github.com/neherlab/covid19_scenarios](https://github.com/neherlab/covid19_scenarios) and we welcome contributions in any form: comments, suggestions, help with development. Join our [Discussion Forum](https://github.com/neherlab/covid19_scenarios/discussions).
A preprint describing covid19-scenarios.org is now available on [medrxiv (doi: 10.1101/2020.05.05.20091363v2](https://www.medrxiv.org/content/10.1101/2020.05.05.20091363v2).
